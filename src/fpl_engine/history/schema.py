"""SQLite schema for historical FPL data.

The schema deliberately separates fixture performance from Gameweek snapshots so
that double Gameweeks can be represented without duplicating price, ownership or
availability data.
"""
...
CREATE TABLE IF NOT EXISTS fixtures (
    ...
    UNIQUE (season_id, source_fixture_id)
);
...
CREATE INDEX IF NOT EXISTS idx_snapshots_gameweek ON player_gameweek_snapshots(gameweek_id);
"""
